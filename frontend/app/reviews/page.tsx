            ...
            <div className="flex flex-col gap-3">
              {reviewsData.items.map((review) => (
                <Link
                  ...
                  className="rounded-lg border border-zinc-200 bg-white p-3 sm:p-4 shadow-sm transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800"
                >
                  <div className="flex flex-col gap-2">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                      <div className="flex-1 min-w-0">
                        <h3 className="font-medium text-sm sm:text-base text-zinc-900 dark:text-zinc-100 break-words">
                          {review.pr_title || `PR #${review.pr_number}`}
                        </h3>
                        <p className="mt-1 text-xs sm:text-sm text-zinc-600 dark:text-zinc-400 break-all">
                    ...
                    <div className="flex flex-wrap gap-x-2 gap-y-1 text-xs text-zinc-500 dark:text-zinc-400">
                      ...
                      <span className="break-words">{formatDate(review.created_at)}</span>
